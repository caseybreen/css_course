...
## Print out solution 
paste("There are approximately", diff_users_gb, "more FB MAU users between the ages of 30 and 40 in Great Britain than between 40 and 50.")
```
...
*The FB gender gap might not be a good predictor of internet gender gaps in settings where only a small, non-representative set of of the population uses FB. For instance, perhaps only the elites of a country use Facebook.*
